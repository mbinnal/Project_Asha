...
public class ProductDeleteTests {
	...
	private ProductDeletePOM productPOM;
	 ...
	 @BeforeTest
		public void logreports()
		{
			...
			extent = new ExtentReports(System.getProperty("user.dir")+"/test-output/testcase3.html",true);//user.dir ==>same directory ,create a folder namked ancy.html
	...
	public void setUp() throws Exception {
	    ...
	    productPOM = new ProductDeletePOM(driver);
