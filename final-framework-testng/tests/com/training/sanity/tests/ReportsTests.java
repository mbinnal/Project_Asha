...
import com.training.pom.ReportsPOM;
...
public class ReportsTests {
	...
	private ReportsPOM reportPOM;
	 ...
	 @BeforeTest
		public void logreports()
		{
			...
			extent = new ExtentReports(System.getProperty("user.dir")+"/test-output/testcase4.html",true);//user.dir ==>same directory ,create a folder namked ancy.html
	...
	public void setUp() throws Exception {
		...
		reportPOM = new ReportsPOM(driver);
