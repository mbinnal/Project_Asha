	...
	ExtentReports extent;//where my report should be
	 ...
	 @BeforeTest
		public void logreports()
		{
			...
			extent = new ExtentReports(System.getProperty("user.dir")+"/test-output/testcase2.html",true);//user.dir ==>same directory ,create a folder namked ancy.html
