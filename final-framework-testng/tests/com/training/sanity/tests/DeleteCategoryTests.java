...
public class DeleteCategoryTests {
	...
	private DeleteCategoryPOM deletePOM;
	 ...
	 @BeforeTest
		public void logreports()
		{
			...
			extent = new ExtentReports(System.getProperty("user.dir")+"/test-output/testcase1.html",true);//user.dir ==>same directory ,create a folder namked ancy.html
	...
	public void setUp() throws Exception {
		...
		deletePOM = new DeleteCategoryPOM(driver);
